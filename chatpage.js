...
function getBotResponse(data, userInput) {
    ...
    for (let intent of data.intents) {
        for (let pattern of intent.patterns) {
            ...
            const lastPatternWord = patternWords[patternWords.length - 1];

           
            if (lastWord === lastPatternWord) {
    ...
    return "Sorry, I didn’t quite understand that. Could you clarify or provide more details?";
}
